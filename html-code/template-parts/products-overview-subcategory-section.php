<section class="products-overview-section">
    <div class="container">
        <div class="title-box">
            <h1 class="page-title">Запасные части</h1>
        </div>
        ...
        <div class="filter-output-box">
            <div class="filter-output">
                <div class="links"><a href="/">Priwoz</a> <span class="sep">-</span> <a href="/">Авто</a> <span class="sep">-</span> <span class="current-page">Запасные части</span></div>
                <div class="count">Выбрано 584</div>
                <a href="/" class="btn btn-refresh">Сбросить</a>
            </div>
        ...
        <div class="container">
            ...
            <div class="products-wrap">
                <div class="grid products-masonry">
                    ...
                    <div class="grid-item product-grid-item">
                        <a href="/" class="box -adv-1">
                            <div class="img">
                                <img class="bg-img" src="/html-code/temporary-images/products/product-adv.png" alt="Priwoz advertisement">
                            </div>
                            <div class="text">
                                <h2 class="product-title">Срочный выкуп авто</h2>
                                <div class="description">в любом состоянии</div>
                            </div>
                            <div class="adv-logo">
                                <img src="/html-code/temporary-images/products/product-adv-logo.png" alt="Priwoz advertisement">
                            </div>
                        </a>
                    </div>
                    <div class="grid-item product-grid-item">
