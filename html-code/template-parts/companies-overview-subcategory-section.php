<section class="company-overview-section">
    <div class="container">
        <div class="title-box">
            <h1 class="page-title">Пассажирские перевозки</h1>
            <label class="form-label d-xs-none d-xl-flex">
                <select class="form-select -simple-location -simple-location-gray">
                    <option value="All" selected>Выберите город</option>
        ...
        <div class="collapse-content-box">
            <div id="search-box" class="collapsed-content d-xl-none">
            ...
            <div class="category-list -simple d-xs-none d-xl-flex">
                <div class="item">
            ...
            <div class="grid companies-masonry">
                    ...
                    <a href="/" class="box">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company2.png"
                                 alt="Priwoz company">
                            <img class="company-logo" src="/html-code/temporary-images/home/company-logo2.png"
                                 alt="Priwoz company logo">
                        </div>
                        <div class="text">
                ...
                <div class="grid-item company-grid-item">
                    <a href="/" class="box -adv">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/advertisement-company.png"
                                 alt="Priwoz company advertisement">
                        </div>
                        <div class="text">
                ...
                <div class="grid-item company-grid-item">
                    <div class="box -video video-open-trigger"
                        ...
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company9.png"
                                 alt="Priwoz company">
                        ...
                        <div class="text">
                            <h2 class="company-title">Как надо мной экспериментировали наши в салоне Modern в
                                Софии </h2>
                        </div>
                    </div>
                </div>
                <div class="grid-item company-grid-item">
                    <a href="/" class="box">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company5.png"
                                 alt="Priwoz company">
                        </div>
                        <div class="text">
                ...
                <div class="grid-item company-grid-item">
                    <a href="/" class="box">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company6.png"
                                 alt="Priwoz company">
                            <img class="company-logo" src="/html-code/temporary-images/home/company-logo5.png"
                                 alt="Priwoz company logo">
                        </div>
                        <div class="text">
                ...
                <div class="grid-item company-grid-item">
                    <a href="/" class="box">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company8.png"
                                 alt="Priwoz company">
                            <img class="company-logo" src="/html-code/temporary-images/home/company-logo6.png"
                                 alt="Priwoz company logo">
                        </div>
                        <div class="text">
                ...
                <div class="grid-item company-grid-item">
                    <a href="/" class="box">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company7.png"
                                 alt="Priwoz company">
                            <img class="company-logo" src="/html-code/temporary-images/home/company-logo7.png"
                                 alt="Priwoz company logo">
                        </div>
                        <div class="text">
