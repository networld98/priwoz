<section class="products-overview-section">
    <div class="container">
        ...
        <div class="search-title-box">
            ...
            <div class="search-output"><span class="current">компаний 3</span> <a href="/">объявлений 22</a></div>
        </div>

        <div class="filter-output-box">
            <div class="filter-output">
                <div class="links"><a href="/">Priwoz</a> <span class="sep">-</span> <a href="/">Диски Original Renault
                        Master</a> <span class="sep">/</span> <span class="current-page">Варна</span></div>
            </div>
        ...
        <div class="companies-wrap">
            <div class="grid companies-masonry">
                ...
                <div class="grid-item company-grid-item">
                    <a href="/" class="box">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company1.png"
                                 alt="Priwoz company">
                            <img class="company-logo" src="/html-code/temporary-images/home/company-logo1.png"
                                 alt="Priwoz company logo">
                        </div>
                        <div class="text">
                ...
                <div class="grid-item company-grid-item">
                    <a href="/" class="box">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/home/company3.png"
                                 alt="Priwoz company">
                            <img class="company-logo" src="/html-code/temporary-images/home/company-logo3.png"
                                 alt="Priwoz company logo">
                        </div>
                        <div class="text">
                ...
                <div class="grid-item company-grid-item">
                    <div class="box -video video-open-trigger"
                         data-video="/html-code/temporary-images/home/video_example.mp4">
                        <div class="img">
                            <img class="bg-img" src="/html-code/temporary-images/products/company-video.png"
                                 alt="Priwoz company">
                            <img class="company-logo" src="/html-code/temporary-images/home/company-logo4.png"
                                 alt="Priwoz company logo">
                            <div class="date">16 октября 2023</div>
                        </div>
                        <div class="text">
                            <h2 class="company-title">Как мне почистили диван в ChistoClean</h2>
                        </div>
                    </div>
                </div>
                <div class="grid-item company-grid-item">
