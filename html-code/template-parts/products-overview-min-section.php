<section class="products-overview-min-section">
    <div class="bg-overlay">
        <div class="container">
            <div class="section-title">Доска объявлений</div>
            <div class="products-wrap">
                <div class="grid">
                    <div class="grid-item product-grid-item">
                        <a href="/" class="box">
                            <div class="img">
                                <img class="bg-img" src="/html-code/temporary-images/companies/product1.png"
                                     alt="Priwoz product">
                            </div>
                            <div class="text">
                                <h2 class="product-title">Автобусные перевозки Чехия Словакия Сербия Венгрия Чехия Богария переезды посылки документы</h2>
                    ...
                    <div class="grid-item product-grid-item">
                        <a href="/" class="box">
                            <div class="img">
                                <img class="bg-img" src="/html-code/temporary-images/companies/product2.png"
                                     alt="Priwoz product">
                            </div>
                            <div class="text">
                                <h2 class="product-title">Автобусные перевозки Чехия Словакия Сербия Венгрия Чехия Богария посылки</h2>
                                <div class="location-date">
                                    <div class="location">Варна</div>
                                    <time datetime="2023-10-14" class="date">14 окт 2023</time>
                                </div>
                    ...
                    <div class="grid-item product-grid-item">
                        <a href="/" class="box">
                            <div class="text">
                                <h2 class="product-title">Автобусные перевозки Чехия Словакия Сербия Венгрия</h2>
                                <div class="location-date">
                                    <div class="location">Варна</div>
                                    <time datetime="2023-10-14" class="date">14 окт 2023</time>
                                </div>
                    ...
                    <div class="grid-item product-grid-item">
                        <a href="/" class="box">
                            <div class="img">
                                <img class="bg-img" src="/html-code/temporary-images/companies/product3.png" alt="Priwoz product">
                            </div>
                            <div class="text">
                                <h2 class="product-title">Грузовые перевозки </h2>
                                <div class="location-date">
                                    <div class="location">Варна</div>
                                    <time datetime="2023-10-14" class="date">14 окт 2023</time>
                                </div>
                ...
                <div class="load-more-box">
                    <a href="/" class="blue-link">На доску объявлений</a>
                </div>
            </div>
        </div>
    </div>
