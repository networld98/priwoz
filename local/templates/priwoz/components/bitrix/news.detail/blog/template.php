    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-9">
                <div class="post-wrap">
                    <time datetime="<?=strtolower(FormatDate("d m Y", MakeTimeStamp($arItem['TIMESTAMP_X']))) ?>" class="date"><?=strtolower(FormatDate("d M Y", MakeTimeStamp($arResult['TIMESTAMP_X']))) ?></time>
