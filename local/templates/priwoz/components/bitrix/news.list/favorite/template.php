...
$payActiveComp = Option::get("priwoz.option", "pay_on_company");
...
foreach ($arResult["ITEMS"] as $arItem):?>
 ...
 if(($arItem["PROPERTIES"]['MODERATION']['VALUE']!='Y' && ($date>=$dateNow || (($payActive == 'N' && $arItem['IBLOCK_ID']==19) || ($payActiveComp == 'N' && $arItem['IBLOCK_ID']==24)))) || $arItem["PROPERTIES"]['AUTHOR']['VALUE']==$USER->GetID()){
        ...
        <<? if ($APPLICATION->GetCurPage() != SITE_DIR."personal/ads-list/" && $APPLICATION->GetCurPage() != SITE_DIR."personal/company-list/" && !$_POST['id']){?>a href="<?= $arItem["DETAIL_PAGE_URL"] ?>"<?}else{?>div<?}?> class="box <?if($arItem["DISPLAY_PROPERTIES"]['CATEGORY']['LINK_SECTION_VALUE']){?>company<?}?>">
            <? if ($arItem['PROPERTIES']['PHOTOS']['VALUE']){
                ...
                <div class="img">
                    ...
                    <?}?>
                    <?if($date<$dateNow && (($payActive == 'Y' && $arItem['IBLOCK_ID']==19) || ($payActiveComp == 'Y' && $arItem['IBLOCK_ID']==24)) && $APPLICATION->GetCurPage() == SITE_DIR . "personal/favorite/"){?>
                        <div class="overlay">
            ...
            <? if ($APPLICATION->GetCurPage() == SITE_DIR."personal/ads-list/" || $APPLICATION->GetCurPage() == SITE_DIR."personal/company-list/" || $_POST['id']) { ?>
                <? if ($active == 'N' || $moderation == 'Y' || ($date < $dateNow && (($payActive == 'Y' && $arItem['IBLOCK_ID']==19) || ($payActiveComp == 'Y' && $arItem['IBLOCK_ID']==24)))) { ?>
                    <div class="overlay overlay-disabled">
                        <? if ($moderation != 'Y' && ($date >= $dateNow || (($payActive == 'N' && $arItem['IBLOCK_ID']==19) || ($payActiveComp == 'N' && $arItem['IBLOCK_ID']==24)))) { ?>
                            <p><?= GetMessage("CT_DISABLED") ?></p>
                        <? } elseif ($moderation == 'Y' && ($date >= $dateNow || (($payActive == 'N' && $arItem['IBLOCK_ID']==19) || ($payActiveComp == 'N' && $arItem['IBLOCK_ID']==24)))) { ?>
                            <p><?= GetMessage("CT_MODERATION") ?></p>
                        <? } elseif ($date < $dateNow && (($payActive == 'Y' && $arItem['IBLOCK_ID']==19) || ($payActiveComp == 'Y' && $arItem['IBLOCK_ID']==24))) { ?>
                            <p><?=GetMessage("T_NO_PAY")?></p>
                        <? } ?>
                    </div>
                <? } ?>
                <div class="overlay">
                    <? if ($date >= $dateNow && (($payActive == 'Y' && $arItem['IBLOCK_ID']==19) || ($payActiveComp == 'Y' && $arItem['IBLOCK_ID']==24))) { ?>
                            ...
                            <div class="col-xs-6 <?if($moderation!='Y'){?>col-md-6<?}else{?>col-md-4<?}?>">
                                <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>" class="overlay-link">
                                    <div class="overlay-icon">
                                        <svg data-name="Layer 1" width="40" height="40" style="width:40px;height:40px;" id="Layer_1" viewBox="0 0 272 272" xmlns="http://www.w3.org/2000/svg"><defs><style>.cls-1{fill:#526172;}</style></defs><title/><rect class="cls-1" height="8" width="24" x="240" y="128"/><rect class="cls-1" height="8" width="24" x="8" y="128"/>
                                            <path class="cls-1" d="M153.82,135.81a58.73,58.73,0,0,1-7.78,1.88,59.66,59.66,0,0,1-20,0,57.17,57.17,0,0,1-7.78-1.87,39.18,39.18,0,0,0,.87-4.9l0-.18c.3-.91.59-1.83.89-2.74a50.08,50.08,0,0,0,7.27,1.79,51.61,51.61,0,0,0,17.49,0A51,51,0,0,0,152,128c.31,1,.63,2,1,2.92h0A39.19,39.19,0,0,0,153.82,135.81Z"/><path class="cls-1" d="M101.41,96H50.62c-15.86,0-28.21,13.34-26.45,28.6l.39,3.4.44,3.83c.16,1.41.38,2.8.67,4.17,4.7,23,25.66,40,50.35,40,24.07,0,44.61-16.13,50-38.31a48.79,48.79,0,0,0,1-5.86l.23-2,.6-5.19C129.62,109.34,117.27,96,101.41,96ZM76,168c-22.13,0-40.65-15.94-43.08-37.09l-.83-7.23a17.07,17.07,0,0,1,4.32-13.42A19,19,0,0,1,50.62,104h50.79a19,19,0,0,1,14.19,6.26,17,17,0,0,1,4.32,13.42l-.81,7.06,0,.18a39.18,39.18,0,0,1-.87,4.9C113.71,154.48,96.39,168,76,168Z"/><path class="cls-1" d="M221.41,96H170.62c-15.86,0-28.21,13.34-26.45,28.6l.59,5.18.24,2a48.8,48.8,0,0,0,1,5.86c5.36,22.18,25.9,38.31,50,38.31,24.68,0,45.65-17,50.35-40,.29-1.37.51-2.76.67-4.17l.44-3.83.39-3.4C249.62,109.34,237.27,96,221.41,96Zm17.68,34.92C236.66,152.06,218.14,168,196,168c-20.39,0-37.71-13.53-42.2-32.19a39.19,39.19,0,0,1-.87-4.88h0l-.84-7.24a17.06,17.06,0,0,1,4.32-13.42A19,19,0,0,1,170.62,104h50.79a19,19,0,0,1,14.19,6.26,17,17,0,0,1,4.32,13.42Z"/></svg>
                                    </div>
