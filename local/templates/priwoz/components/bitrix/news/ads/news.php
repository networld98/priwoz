        ...
        <? } else {
            ...
            <div class="author-wrap">
                ...
                <div class="phone-link">
                    <? if ($userPhone) { ?>
                    <a target="_blank" href="tel:<?= $userPhone ?>"><?= $userPhone ?></a>
                    <?}?>
                </div>
                <ul class="menu -social">
                    <? if ($userTelega) {
                        ...
                        <li>
                            <a target="_blank" href="https://telegram.me/<?= $userTelega ?>" target="_blank">
                    ...
                    <? if ($userViber) { ?>
                        <li>
                            <a target="_blank" href="viber://chat?number=<?= $userViber ?>">
                    ...
                    <? if ($userWhats) { ?>
                        <li>
                            <a target="_blank" href="whatsapp://send?phone=<?= $userWhats ?>">
