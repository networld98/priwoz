        ...
        <div class="container">
            <div class="row align-items-xs-center">
                ...
                <div class="d-xs-none d-md-block col-md-3 d-xl-none full-height">
                    <div class="main-link">
                        <a href="<?=SITE_DIR?>ads/">Доска объявлений</a>
                    </div>
                </div>
                <div class="col-xs-2 col-md-1 d-xs-block d-xl-none full-height">
        ...
        <div class="inner">
            <div class="container">
                <div class="title-wrap">
                    ...
                    <a href="<?=SITE_DIR?>companies/" class="all-link">Все компании</a>
                </div>
    ...
    <div class="popup-menu mobile-menu" id="mobile-menu">
        <div class="inner">
            <ul class="menu main-menu">
                ...
                <li><a href="<?=SITE_DIR?>personal/company/" class="-green">Добавить компанию</a></li>
                <li><a href="<?=SITE_DIR?>personal/announcement/" class="-orange">Добавить объявление</a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="inner">
            <div class="container">
                <div class="buttons-wrap">
                    <div class="row">
                        <div class="col-xs-12 col-md-6"><a href="<?=SITE_DIR?>personal/company/" class="btn btn-large btn-green">Добавить
                                компанию</a></div>
                        <div class="col-xs-12 col-md-6"><a href="<?=SITE_DIR?>personal/announcement/" class="btn btn-large btn-orange">Добавить
                                компанию</a></div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row align-items-md-center">
                ...
                <div class="col-xl-4">
                    <div class="buttons-wrap">
                        <div class="row">
                            <div class="col-xs-12 col-md-6"><a href="<?=SITE_DIR?>personal/company/" class="btn btn-green">Добавить компанию</a></div>
                            <div class="col-xs-12 col-md-6"><a href="<?=SITE_DIR?>personal/announcement/" class="btn btn-orange">Добавить объявление</a></div>
                        </div>
                    </div>
                </div>
            </div>
...
<?endif;?>
<? if($APPLICATION->GetCurPage() != "/ua/" &&  $APPLICATION->GetCurPage() != "/" && $curPagePath[1] !== "personal" && $curPagePath[1] !== "auth"):?>
